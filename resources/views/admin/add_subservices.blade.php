    ...
    <section class="main_content dashboard_part">
        <nav aria-label="breadcrumb" class="mb-5">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page" style="text-decoration: none;color:#033496;font-weight:600;font-size:18px;">Add Sub Services</li>
            </ol>
        </nav>
                ...
                <div class="row dashboard-header" style="">
                    <div class="col-md-11  mx-auto">
                        <form class="notification-form shadow rounded"
                            action="{{ route('sub-services-store') }}"
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control" id="description" aria-describedby="textHelp" placeholder="Please enter your description" style="font-size: 15px;">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
